...
var gameMoves = [null, null, null, null, null, null, null, null, null];
var gameStatus = false;

var checkWinner = function checkWinner() {
  if (gameMoves[0] === gameMoves[1] && gameMoves[1] === gameMoves[2] && gameMoves[2] !== null || gameMoves[0] === gameMoves[4] && gameMoves[4] === gameMoves[8] && gameMoves[8] !== null || gameMoves[0] === gameMoves[3] && gameMoves[3] === gameMoves[6] && gameMoves[6] !== null || gameMoves[3] === gameMoves[4] && gameMoves[4] === gameMoves[5] && gameMoves[5] !== null || gameMoves[6] === gameMoves[7] && gameMoves[7] === gameMoves[8] && gameMoves[8] !== null || gameMoves[1] === gameMoves[4] && gameMoves[4] === gameMoves[7] && gameMoves[7] !== null || gameMoves[2] === gameMoves[5] && gameMoves[5] === gameMoves[8] && gameMoves[8] !== null || gameMoves[2] === gameMoves[4] && gameMoves[4] === gameMoves[6] && gameMoves[6] !== null) {
    gameStatus = true;
    declareWinner();
  } else if (turn === 9) {
    gameStatus = true;
...
var updateMove = function updateMove(index, value) {
  var over = gameStatus;
  var cell = {};
  cell.index = index;
  cell.value = value;
  ...
  api.update(updateObj).then(ui.updateMoveSuccess).catch(ui.updateMoveFail);
};
...
var reset = function reset(event) {
  ...
  $('#message').text(null);
  turn = 0;
  api.create().then(ui.createSuccess).catch(ui.createFail);
};
...
var onJoin = function onJoin(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.update(data).then(ui.joinSuccess).catch(ui.joinFail);
};

var onGetGames = function onGetGames(event) {
  event.preventDefault();
  api.index().then(ui.getGamesSuccess).catch(ui.getGamesFail);
};
...
var onGetGame = function onGetGame(event) {
  ...
  var data = getFormFields(this);
  var id = data.id;
  api.show(id).then(ui.showSuccess).catch(ui.showFail);
};
...
var joinFail = function joinFail() {
...
var showFail = function showFail() {
